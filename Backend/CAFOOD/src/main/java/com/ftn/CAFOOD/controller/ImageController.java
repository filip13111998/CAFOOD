...
public class ImageController {
	...
	public ResponseEntity<String> uplaodImage(@RequestParam("imageFile") MultipartFile file) throws IOException {
		...
		Image img = new Image(compressBytes(file.getBytes()), file.getOriginalFilename(),false);
	...
	public Image getImage(@PathVariable("imageName") String imageName) throws IOException {
		...
		final Optional<Image> retrievedImage = imageRepository.findOneByName(imageName);
